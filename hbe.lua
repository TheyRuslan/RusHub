...
local EspOffsetY = 30  -- Ajusta este valor para cambiar la posición vertical del ESP
local EspOffsetX = 10   -- Ajusta este valor para cambiar la posición horizontal del ESP
